...
type FakeBackupArtifactFinder struct {
	ListBlobsStub        func() (map[string]gcs.Blob, error)
...
func (fake *FakeBackupArtifactFinder) ListBlobs() (map[string]gcs.Blob, error) {
...
func (fake *FakeBackupArtifactFinder) ListBlobsCallCount() int {
	fake.listBlobsMutex.RLock()
	defer fake.listBlobsMutex.RUnlock()
	return len(fake.listBlobsArgsForCall)
}

func (fake *FakeBackupArtifactFinder) ListBlobsReturns(result1 map[string]gcs.Blob, result2 error) {
...
func (fake *FakeBackupArtifactFinder) ListBlobsReturnsOnCall(i int, result1 map[string]gcs.Blob, result2 error) {
	fake.ListBlobsStub = nil
...
func (fake *FakeBackupArtifactFinder) Invocations() map[string][][]interface{} {
...
func (fake *FakeBackupArtifactFinder) recordInvocation(key string, args []interface{}) {
