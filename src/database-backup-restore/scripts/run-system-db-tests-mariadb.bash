...
pushd "$SRC_DIR"
  ...
  export MYSQL_CA_CERT_PATH="${MYSQL_CERTS_PATH}/ca-cert.pem"
  export MYSQL_CLIENT_CERT_PATH="${MYSQL_CERTS_PATH}/client-cert.pem"
  export MYSQL_CLIENT_KEY_PATH="${MYSQL_CERTS_PATH}/client-key.pem"
  ...
  export MARIADB_DUMP_PATH="$(which mariadb-dump)"
  export MARIADB_CLIENT_PATH="$(which mariadb)"
