...
# Needs an input named "backup-and-restore-sdk-release", generated with the Concourse PR Resource:
...
GIT_PR_ID=$(cat backup-and-restore-sdk-release/.git/resource/pr)
